...
final _mockStories = [
  Story(
    ...
    date: DateTime.now(),
    caption: 'Sahilde 3 saat telefonsuz yurudum. Dalga sesleri terapi gibi.',
  ...
  Story(
    ...
    date: DateTime.now(),
    caption: 'Kitap okuyorum, telefon diger odada. Huzur bu olmali.',
    activityType: 'Kitap',
  ...
  Story(
    ...
    date: DateTime.now(),
    caption: 'Parkta kosu, kulakliklari evde biraktim. Kus sesleri > Spotify.',
    activityType: 'Kosu',
