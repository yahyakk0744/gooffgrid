...
final friendsProvider = Provider<List<FriendData>>((ref) {
  return [
    FriendData(
      profile: UserProfile(id: 'f1', name: 'Deniz', avatarColor: const Color(0xFFF093FB), city: 'Adana', country: 'Türkiye', ageGroup: '18-24', level: 7, title: 'Off-Grid Ciragi', streak: 12, bestStreak: 20, totalPoints: 2800, createdAt: DateTime(2025, 1, 10)),
      todayMinutes: 95, isOnline: true, topApp: 'Instagram', topAppMinutes: 30,
    ),
    FriendData(
      profile: UserProfile(id: 'f2', name: 'Berk', avatarColor: const Color(0xFF4FACFE), city: 'Adana', country: 'Türkiye', ageGroup: '18-24', level: 3, title: 'Scroll Asistani', streak: 2, bestStreak: 5, totalPoints: 420, createdAt: DateTime(2025, 2, 1)),
    ...
    FriendData(
      profile: UserProfile(id: 'f4', name: 'Can', avatarColor: const Color(0xFFFF6B00), city: 'Ankara', country: 'Türkiye', ageGroup: '18-24', level: 4, title: 'Farkinda Gezgin', streak: 5, bestStreak: 9, totalPoints: 750, createdAt: DateTime(2025, 1, 20)),
    ...
    FriendData(
      profile: UserProfile(id: 'f7', name: 'Zeynep', avatarColor: const Color(0xFF69C9D0), city: 'Bursa', country: 'Türkiye', ageGroup: '18-24', level: 5, title: 'Dijital Diyetci', streak: 7, bestStreak: 12, totalPoints: 1100, createdAt: DateTime(2025, 1, 25)),
      todayMinutes: 145, isOnline: true, topApp: 'Reddit', topAppMinutes: 55,
    ),
    FriendData(
      profile: UserProfile(id: 'f8', name: 'Kaan', avatarColor: const Color(0xFFFFD700), city: 'Adana', country: 'Türkiye', ageGroup: '25-34', level: 9, title: 'Zaman Ustasi', streak: 28, bestStreak: 45, totalPoints: 4800, createdAt: DateTime(2024, 11, 1)),
