...
final _friends = [
  ...
  const RankingEntry(rank: 5, userId: 'u5', name: 'Selin', avatarColor: AppColors.neonOrange, level: 4, totalMinutes: 210, change: -2),
...
final _city = [
  ...
  const RankingEntry(rank: 14, userId: 'u5', name: 'Selin', avatarColor: AppColors.neonOrange, level: 4, totalMinutes: 210, change: -2),
...
final _country = [
  ...
  const RankingEntry(rank: 4, userId: 't4', name: 'Dilan', avatarColor: AppColors.neonOrange, level: 9, totalMinutes: 49, change: 2),
  ...
  const RankingEntry(rank: 20, userId: 't18', name: 'Demir', avatarColor: AppColors.neonOrange, level: 5, totalMinutes: 215, change: -1),
];
...
final _global = [
  ...
  const RankingEntry(rank: 3, userId: 'g3', name: 'Priya', avatarColor: AppColors.neonOrange, level: 10, totalMinutes: 25, change: -1),
  ...
  const RankingEntry(rank: 19, userId: 'g19', name: 'Mei', avatarColor: AppColors.neonOrange, level: 6, totalMinutes: 170, change: -2),
...
final _age = [
  ...
  const RankingEntry(rank: 5, userId: 'a5', name: 'Melis', avatarColor: AppColors.neonOrange, level: 7, totalMinutes: 88, change: 0),
  ...
  const RankingEntry(rank: 15, userId: 'u5', name: 'Selin', avatarColor: AppColors.neonOrange, level: 4, totalMinutes: 210, change: -2),
